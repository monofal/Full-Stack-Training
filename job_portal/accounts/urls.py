...
urlpatterns = [
    ...
    path('employee/qualification/', include([
         path('add', AddQualificationView.as_view(),
              name='add-qualification'),
         path('update/<int:pk>', UpdateQualificationView.as_view(),
              name='update-qualification'),
         path('delete/<int:pk>', DeleteQualificationView.as_view(),
              name='delete-qualification'),
    ])),
    path('employee/document/', include([
         path('add', AddDocumentView.as_view(),
              name='add-document'),
         path('update/<int:pk>', UpdateDocumentView.as_view(),
              name='update-document'),
         path('delete/<int:pk>', DeleteDocumentView.as_view(),
