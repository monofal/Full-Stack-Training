...
from twitter_mining.exception.exception import handle_error
from twitter_mining.http.response import Response


class HttpHandler(object):
    """
    Handle api calls to REST APIs
    """
    ...
    def _build_client(self, name=None):
        ...
        return HttpHandler(host=self.host,
